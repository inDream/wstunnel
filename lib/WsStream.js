...
(function() {
  ...
  module.exports = WsStream = (function(_super) {
    ...
    function WsStream(ws) {
      ...
      this.ws.on('message', (function(_this) {
        return function(message) {
          var raw = message.binaryData.toString('utf8');
          raw = raw.replace('Host: localhost', 'Host: ' + ws.ip);
          raw = new Buffer(raw.toString('binary'), 'binary');
          if (_this._open) {
            return _this.push(raw);
          }
        };
      })(this));
